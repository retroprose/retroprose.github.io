...
var ASM_CONSTS = {
 ...
 6278503: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 6278586: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 6278655: () => { return window.innerWidth; },  
 6278685: () => { return window.innerHeight; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 6211792;
